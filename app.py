...
def run():
    ...
    st.markdown("<h7 style='text-align: center; color: red;'>Note: If you are using a phone to take a selfie to upload for processing, you will have to rotate your phone by 90 degrees to the left for it to be properly processed for analysis</h7>", unsafe_allow_html=True)
