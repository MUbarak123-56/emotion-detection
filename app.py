...
def run():
    ...
    st.markdown("<h7 style='text-align: center; color: red;'>Extra Note: The model might be terrible at detecting the toddler/children's faces, so it will yield an error upon uploading their images.</h7>", unsafe_allow_html=True)
